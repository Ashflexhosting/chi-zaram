...
const products = [
  ...
  { number: "05", title: "Cleaning Essentials & Fragrance", label: "CHI-ZARAM HOME & FRAGRANCE", copy: "Practical home care products and concentrated oil perfumes for daily living, gifting, and resale.", image: "/manus-storage/chi-zaram-gen-home_7c839812.jpg", details: ["Home care and cleaning essentials", "Concentrated oil perfumes", "Personal, gifting, and wholesale use"], accent: "cream" },
];
