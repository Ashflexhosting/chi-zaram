            ...
            <div className="category-grid">
              {categories.map((category) => (
                ...
                >
                  ...
                  <img className="category-card__mark" src={assetPath("/manus-storage/chizaram-logo-cz-mark_6dff130a.webp")} alt="" />
