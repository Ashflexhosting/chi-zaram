      ...
      <header className="site-header">
        <div className="container site-header__inner">
          <a className="brand-lockup" href="#top" aria-label="CHI-ZARAM home">
            <img src={assetPath("/manus-storage/chizaram-logo.webp")} alt="CHI-ZARAM Palm Oil & More" className="brand-lockup__mark" />
      ...
      <main id="top">
            ...
            <div className="category-grid">
              {categories.map((category) => (
                ...
                >
                  ...
                  <img className="category-card__mark" src={assetPath("/manus-storage/chizaram-logo-mark.webp")} alt="" />
        ...
        <section className="palm-section section-pad" id="palm-oil">
          <div className="container palm-section__inner">
            <div className="palm-section__visual"><img src={assetPath("/manus-storage/chi-zaram-gen-palmoil_d61695e1.jpg")} alt="CHI-ZARAM 5 Litre Palm Oil container with palm fruits" loading="lazy" /><img className="palm-section__brand-stamp" src={assetPath("/manus-storage/chizaram-logo-mark.webp")} alt="" /><div className="palm-section__badge"><span>Family size</span><strong>5L</strong><small>lasting value</small></div></div>
