          ...
          <div className="container hero-section__inner">
            ...
            <div className="hero-visual">
              <div className="hero-visual__image-wrap">
                <picture>
                  <source media="(min-width: 1280px)" srcSet={assetPath("/manus-storage/oil_4012c960.png")} />
                  <img src={assetPath("/manus-storage/oil_4012c960.png")} alt="CHI-ZARAM product showcase featuring 5L red palm oil, vegetable oil, yellow garri, and fresh palm fruits" fetchPriority="high" decoding="async" />
                </picture>
